...
**Note: it will be your job as the app developer to ensure that filenames are sanitized before uploading the file to BigDisk (e.g. make sure filenames are unique, have no spaces, and contain no URL query delimiting characters like ! @ # $ % etc.).**
